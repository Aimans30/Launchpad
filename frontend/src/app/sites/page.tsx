...
export default function SitesPage() {
  ...
  const handleDeleteSite = async (siteId: string) => {
    ...
    try {
      ...
      console.log('Site deleted successfully:', result);
      ...
      const successMessage = `Site "${result.deletedSite?.name || 'Unknown'}" deleted successfully`;
              ...
              <div className="relative p-6">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-slate-700/50">
                  ...
                  <button
                    ...
                    className="inline-flex items-center text-red-400 hover:text-red-300 transition-colors gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    ...
                    {deleteLoading === site.id ? 'Deleting...' : 'Delete'}
                  </button>
                </div>
              </div>
            </div>
